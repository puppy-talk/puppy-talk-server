...
public record AiResponse(
     ...
     * 기본 응답을 생성합니다.
     */
    public static AiResponse create(String content, String model, String providerId) {
     ...
     */
    public static AiResponse create(String content, String model, String providerId, Integer tokensUsed) {
     ...
     * 메타데이터와 함께 응답을 생성합니다.
     */
    public static AiResponse create(String content, String model, String providerId, Integer tokensUsed, Map<String, Object> metadata) {
